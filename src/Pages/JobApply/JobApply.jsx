...
import { FaLinkedin, FaGithub, FaFilePdf, FaPaperPlane, FaArrowLeft } from "react-icons/fa";
...
const JobApply = () => {
  ...
  const inputClass = "w-full pl-12 pr-4 py-4 rounded-2xl border border-gray-200 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-100 outline-none transition-all bg-white text-gray-800 placeholder:text-gray-400 font-medium";
  const labelClass = "block text-sm font-black text-gray-600 mb-2 ml-1 uppercase tracking-widest";
    ...
    <div className="min-h-screen bg-[#f8fafc] py-16 px-4">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="mb-10 flex flex-col items-center text-center">
            <Link to={`/jobDetails/${jobId}`} className="flex items-center gap-2 text-indigo-600 font-black text-sm mb-4 hover:gap-3 transition-all">
                <FaArrowLeft /> Back to Job Details
            </Link>
            <h2 className="text-4xl font-black text-gray-900 tracking-tight">
                Submit Your <span className="text-indigo-600">Application</span>
            </h2>
            <p className="text-gray-500 mt-2 font-medium italic">Apply as: {user?.email}</p>
        </div>

        {/* Form Card */}
        <form onSubmit={handleApplyFormSubmit} className="bg-white rounded-[3rem] p-8 md:p-12 shadow-2xl shadow-indigo-100/50 border border-gray-100 space-y-8">
          ...
          <div className="relative">
            ...
            <p className="text-[10px] text-gray-400 mt-2 ml-1 font-bold italic">* Please make sure the link is public</p>
          </div>
